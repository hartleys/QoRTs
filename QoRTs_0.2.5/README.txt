# QoRTs v0.2.5
(Compiled Tue Mar  3 14:17:52 EST 2015)
...
The R package can be installed in R using the command:
    ...
    > install.packages("QoRTs_0.2.5.tar.gz", repos = NULL, type="source")

or using the command-line:
    
    R CMD INSTALL QoRTs_0.2.5.tar.gz
...
with the command:
    ...
    install.packages("QoRTsExampleData_0.2.5.tar.gz", repos = NULL, type="source")
