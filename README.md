# QoRTs v0.1.11
(Compiled Wed Feb 18 15:21:00 EST 2015)
...
The R package can be installed in R using the command:
    ...
    > install.packages("QoRTs_0.1.11.tar.gz", repos = NULL, type="source")

or using the command-line:
    
    R CMD INSTALL QoRTs_0.1.11.tar.gz
...
with the command:
    ...
    install.packages("QoRTsExampleData_0.1.11.tar.gz", repos = NULL, type="source")
