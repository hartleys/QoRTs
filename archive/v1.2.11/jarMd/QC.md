...
> Prefix to be prepended to all output files. If this is set, all output files will use the format: "outfiledir/prefix.QC.qcfilename.txt.gz" (CommaDelimitedListOfStrings)
