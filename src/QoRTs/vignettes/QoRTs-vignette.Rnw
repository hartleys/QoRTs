...
\date{August 8 2014\\
March 16, 2015 %REPLACE_THIS_LINE_WITH_REVISION_DATE
\\
v0.2.7 %REPLACE_THIS_LINE_WITH_VERSION_NUMBER
}
...
\myincfig{indivPlot-9}{0.65\textwidth}{Cumulative Gene Diversity}
...
\myincfig{indivPlot-12}{0.55\textwidth}{Gene assignment rates}
...
\myincfig{indivPlot-13}{0.55\textwidth}{Splice junction loci}
...
More information and a full accounting of all parameters and options can be found in the online documentation\footnote{Found here: \url{https://dl.dropboxusercontent.com/u/103621176/QoRTs/helpDocs/jarHtml/mergeWig.html}}, or by using the command:
\begin{verbatim}
...
More information and a full accounting of all parameters and options can be found in the online documentation\footnote{Found here: \url{https://dl.dropboxusercontent.com/u/103621176/QoRTs/helpDocs/jarHtml/makeJunctionTrack.html}}, or by using the command:
\begin{verbatim}
