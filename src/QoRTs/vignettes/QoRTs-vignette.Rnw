...
\date{August 8 2014\\
February 11, 2015 %REPLACE_THIS_LINE_WITH_REVISION_DATE
\\
v0.1.7 %REPLACE_THIS_LINE_WITH_VERSION_NUMBER
}
...
%----------
\subsection{Replicate decoder} \label{sec:decoder}
%----------
