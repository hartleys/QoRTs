...
object runner {
  ...
  final val QORTS_COMPILE_DATE = "Fri Feb 20 11:46:21 EST 2015"; // REPLACE_THIS_QORTS_DATE_VARIABLE_WITH_DATE          (note this exact text is used in a search-and-replace. Do not change it.)
